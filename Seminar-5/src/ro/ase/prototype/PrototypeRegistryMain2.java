...
public class PrototypeRegistryMain2 {
		public static void main(String[]args) throws CloneNotSupportedException {
			...
			BuildingBlock b3=(BuildingBlock)b1.clone();
			b3.setX(2);
			b3.setY(0);
			b3.setZ(0);
			
			BuildingBlock b4=(BuildingBlock)b1.clone();
			b4.setX(0);
			b4.setY(0);
			b4.setZ(1);
			
			BuildingBlock b5=(BuildingBlock)b1.clone();
			b5.setX(1);
			b5.setY(0);
			b5.setZ(1);
